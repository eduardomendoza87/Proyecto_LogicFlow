  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
      <div className="bg-cafe4Personalizado w-full max-w-4xl rounded-lg shadow-lg p-10">
        <h2 className="text-3xl font-semibold mb-2 text-center">Agregar nuevo usuario</h2>
        <h5 className="text-xl font-medium mb-10 text-center">
          Llena el formulario para registrar un nuevo usuario en la plataforma UCLA.
        </h5>
                ...
                {tipoID && (
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      type="text"
                      required
                      aria-label={tipoID === "matricula" ? "Campo matrícula" : "Campo ID"}
