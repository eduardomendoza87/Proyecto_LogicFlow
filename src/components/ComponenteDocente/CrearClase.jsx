  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
      <div className="bg-cafe4Personalizado w-full max-w-4xl rounded-lg shadow-lg p-10">
        <h2 className="text-3xl font-semibold mb-4 text-center">Crear clase</h2>
        <h5 className="text-xl font-medium mb-6 text-center">
          Crea la clase correspondiente al módulo seleccionado
        </h5>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="bg-blancoPersonalizado p-6 rounded-lg shadow-md col-span-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {/* Descripción */}
                <div>
                  <label htmlFor="descripcion_clase" className="block font-bold mb-1">
                ...
                {tipoMaterial === "link" && (
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border rounded py-2 px-3 shadow focus:ring-2 focus:ring-cafe3Personalizado transition duration-200"
                    />
                  </div>
                )}
